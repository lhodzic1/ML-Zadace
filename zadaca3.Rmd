...
```{r}
model1 <- fanny(podaci, k = 2, stand = TRUE)
fviz_cluster(model1, ellipse.type = "norm", repel = TRUE)
model4 <- fanny(podaci, k = 3, stand = TRUE)
fviz_cluster(model4, ellipse.type = "norm", repel = TRUE)
model5 <- fanny(podaci, k = 4, stand = TRUE)
fviz_cluster(model5, ellipse.type = "norm", repel = TRUE)
model2 <- fanny(podaci, k = 7, stand = TRUE)
